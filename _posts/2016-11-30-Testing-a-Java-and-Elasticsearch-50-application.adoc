...
As y colleague https://twitter.com/mickaeljeanroy/status/804263195359715328[MickaelJeanroy pointed out], we could also start this Docker container from JUnit.
