...
One of my 2017 resolutions will be to try different languages and see how they compare to Java.
...
Yet I don't expect to learn a new language each week though, since it took me several weeks for Ruby.
...
This looks like Java's try-with-resources statement.
